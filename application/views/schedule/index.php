...
echo '    <div class="col-sm-12">';
echo '      <div class="form-group">';
echo '        <input name="form_email" class="form-control" type="email" placeholder="Email (*)" required>';
echo '       </div>';
echo '    </div>';
echo '  </div>';
...
echo '    <div class="col-sm-12">';
echo '      <div class="form-group">';
echo '        <input name="form_phone" class="form-control required" type="text" placeholder="Điện thoại (*)" required>';
echo '       </div>';
echo '    </div>';
