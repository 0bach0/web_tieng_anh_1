...
class Schedule_model extends CI_Model {
    ...
    public function get_schedule_list()
    {
      ...
      $this->db->select('curriculum.id, title');
    ...
    {
      $this->db->select('curriculum_id, title,class_name,schedule,start_day,fee,show_item,schedule.id,other_benefit');
      $this->db->from('curriculum');
    ...
    {
      $this->db->select('curriculum_id, title,class_name,schedule,start_day,fee');
      $this->db->from('curriculum');
